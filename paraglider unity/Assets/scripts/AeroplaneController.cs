...
public class AeroplaneController : MonoBehaviour
{
	...
	void CaluclateAerodynamicEffect ()
	{
		...
		if (GetComponent<Rigidbody>().velocity.magnitude > 0) {
            ...
            var newVelocity = (aerodynamicEffect == 0)? (transform.forward * ForwardSpeed) :  Vector3.Lerp(GetComponent<Rigidbody>().velocity, transform.forward * ForwardSpeed, aeroFactor * ForwardSpeed * aerodynamicEffect * Time.deltaTime);
